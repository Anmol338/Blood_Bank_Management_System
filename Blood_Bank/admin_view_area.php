...
$sql="Select state.STATE_NAME, city.CITY_NAME, area.AREA_NAME, area.AREA_ID
From area Inner Join
  city On area.CITY_ID = city.CITY_ID Inner Join
  state On area.STATE_ID = state.STATE_ID $limit ";

 $textline1="Total Areas : $rows";
