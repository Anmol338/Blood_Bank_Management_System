...
?>
    ...
    <div class="container" style="margin-top:70px;">
            ...
            <div class="col-md-4">
                ...
                <p>
                    Life Line &amp; <br>Blood Management Application, <br>
					Kathmandu, Nepal<br>
                </p>
                <p><i class="fa fa-phone"></i> 
                    <abbr title="Phone">Phone</abbr>: 9845215468</p>
                <p><i class="fa fa-envelope-o"></i> 
                    <abbr title="Email">Email</abbr>: <a href="#" >lifeline@gmail.com</a>
                </p>
				<p><i class="fa fa-globe"></i> 
                    <abbr title="Website">Website</abbr>: <a href="index.php">www.lifeline.com</a></p>
